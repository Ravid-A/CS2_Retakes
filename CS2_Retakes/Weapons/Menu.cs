...
using static Weapons.WeaponsAllocator;
...
public class WeaponsMenu
{
    ...
    {
        ChatMenu menu = new ChatMenu($"{PREFIX_MENU} Select a T Primary Weapon");
    ...
    {
        ChatMenu menu = new ChatMenu($"{PREFIX_MENU} Select a CT Primary Weapon");
    ...
    {
        ChatMenu menu = new ChatMenu($"{PREFIX_MENU} Select a Secondary Weapon");
    ...
    {
        ChatMenu menu = new ChatMenu($"{PREFIX_MENU} Select when to give the AWP");
